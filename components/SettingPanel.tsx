...
const settingsPanel = createSettings({
  ...
  ease: [
    ...
    },
    {
      ...
      setting: "Text Cursor",
      text: "ms-settings:easeofaccess-cursor",
    },
    {
      icon: AccessSearchIcon,
      setting: "Magnifier",
      text: "ms-settings:easeofaccess-magnifier",
    },
    {
      icon: AccessColorsIcon,
      setting: "Color Filters",
      text: "ms-settings:easeofaccess-colorfilter",
    },
    {
...
const SettingPanel = ({ router }: { router: NextRouter }) => {
      ...
      <div className={styles.header_list}>
        {icons.map(
          (setting) =>
            ...
            )) || <div style={{ height: 60 }} key={setting.text}></div>
        )}
      </div>
    </>
  );
